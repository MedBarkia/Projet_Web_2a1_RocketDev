...
$listeReclamations = $reclamationC->afficherReclamation3();
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <a href="exporterReclamation.php" class="btn pull-right" > Exporter PDF </a>
                  <a href="trierReclamation.php" class="btn pull-right" > Trier la liste </a>
                  </h3>
      <form class="navbar-form" method="GET">
              <div class="input-group no-border">
              <input type="text" id="myInput"class="btn" onkeyup="myFunction()" placeholder="Search">
                <button type="submit" name="envoyer" class="btn btn-white btn-round btn-just-icon">
                  <i class="material-icons">search</i>
                  <div class="ripple-container"></div>
                </button>
              </div>
...
foreach($listeReclamations as $reclamation){
  if ($listeReclamations->rowCount()>0){
   while ($reclamation = $listeReclamations->fetch()){
  ?>
  <tr>
  ...
  <td>
  <a href="index.php" class="btn btn-primary pull-right" > Email </a>
  </td>
  </tr>
  <?PHP
   }
...
?>
      ...
      <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <a href="affichertyperec.php" class="btn btn-primary pull-right" > Type </a>
                  </h3>
                </div>
                </div>
