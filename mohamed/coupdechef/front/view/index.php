...
<body id="page-top" class="regular-navigation">
    ...
    <div class="master-wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.2s">
            <div class="container-fluid">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand smoothie" href="index.php"> <span class="theme-accent-color">COUP</span> DE <span class="theme-accent-color">CHEF</span></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="appearRec.html" class="page-scroll">Contact US</a></li>               
                        <li class="dropdown">
        ...
        <section id="Specials" class="dark-wrapper top-border-me opaqued parallax" data-parallax="scroll" data-image-src="assets/img/bg/bg4.jpg" data-speed="0.8">
            <div class="section-inner">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/8-in-1 Kitchen Tool.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Baker's Dusting Wand.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Piece Double Sided Silicone Utensils.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Electric Breakfast Sandwich Maker.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Butter Spreader Knife.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Pineapple Corer.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Quesadilla Maker.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Lasagna Trio Pan.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Épicerie Sucrée & Salée.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Conserves.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Miel.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Fruits, Noix et Snacks.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Condiments & Sauces.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Huiles de cuisson, Huile d'olives.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Farine & Semoule.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../assets/img/produit/Thon & Sardine.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
        ...
        <section id="Book" class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="../assets/img/bg/bg4.jpg" data-speed="0.8">
            <div class="section-inner">
                 <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <div class="row">
                                ...
                                <form  method="POST" action="ajoutReclamation.php" id="contactform" class="form-group main-contact-form col-md-12 wow fadeIn" data-wow-delay="0.2s">
                                    <input type="text" class="form-control col-md-4" name="nom" placeholder="Your Name *" id="nom"  >
                                    <input type="email" class="form-control col-md-4" name="email" placeholder="Your Email *" id="email"  >
                                    <input type="text" class="form-control col-md-4" name="type" placeholder="Your Subject *" id="type"  >
        ...
        <form  method="POST" action="ajoutReclamation.php" id="contactform" class="form-group main-contact-form col-md-12 wow fadeIn" data-wow-delay="0.2s">
                                    ...
                                    <input type="text" class="form-control col-md-4" name="type" placeholder="Your Subject *" id="type"  >
                                    <textarea name="description" class="form-control" id="description" placeholder="Your Message *"></textarea>
                                    <input class="btn btn-primary btn-white mt30 pull-right" type="submit" id ="submit" name="submit" value="send" >
                                </form>     
        </section>
