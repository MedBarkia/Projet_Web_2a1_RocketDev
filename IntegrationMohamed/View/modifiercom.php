			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						<form action="updatecom.php" method="POST"  onsubmit="return valider()" name="MonForm" id="formulairee">
							<div class="row">
					          		<h3>modifier votre commentaire</h3>
									<div class="col-md-12">
										<div class="form-group">

											<input type="text" class="form-control" id="id" name="id" value=<?PHP echo $_POST['id']; ?> readonly>
                                    ...
                                    <div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="idclient" name="idclient" value=<?PHP echo $_POST['idclient']; ?> readonly>
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
