...
<body class="">
  ...
  <div class="wrapper ">
    ...
    <form   onsubmit="return validateForm()" name="myForm" action="update.php" method="POST">
    <table border="0" align="center">
        ...
        <tr>
            ...
            <td><input type="text" name="idp" id="idp" maxlength="20"  class="form-control" value = "<?php echo $_GET['idp'] ?>" >  <span class="error" id="errorid"></span></p> </td>
        </tr>
        <tr>
            <td>
                <label for="nom">nom:
            ...
            <td><input type="text" name="nom" id="nom" maxlength="20"   class="form-control"   >  <span class="error" id="errorname"></span></p> </td> 
        </tr>
        ...
        <td>
            ...
            <td>
                <input type="date" name="dateajout" id="dateajout"   class="form-control" >  <span class="error" id="errordate"></span></p>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="file" name="image" id="image"  class="form-control"  value = "<?php echo $_GET['image'] ?>" > <span class="error" id="errorimage"></span></p>
            </td>
        </tr>
        <tr>
            <td>
