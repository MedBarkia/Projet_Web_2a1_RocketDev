...
<?PHP
    ...
    $listelivraison=$commandec->affichercommande();
...
<html>
    ...
    <body>
        ...
        <button><a href="Ajoutlivraison.php">Ajouter une commande</a></button>
        <hr>
        ...
        <table border=1 align = 'center'id="dataTable">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="modifierlivraison.php?id=<?PHP echo $commande['id']; ?>"> Modifier </a>
                    </td>
                </tr>
            <?PHP
                }
