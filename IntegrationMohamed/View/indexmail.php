                ...
                <div class="card-body">
                    ...
                    <form action="mail.php" method="post" class="form-signin">
                        <div class="form-label-group">
                            ...
                            <input type="text" name="fromEmail" id="fromEmail" class="form-control"  value="eyabouthouri00@gmail.com" readonly required autofocus>
                        </div> <br/>
                        <div class="form-label-group">
                            <label for="inputEmail">To <span style="color: #FF0000"></span></label>
                            <input type="text" name="toEmail" id="toEmail" class="form-control" placeholder="Email address" value="eyabouthouri00@gmail.com" required autofocus>
                        </div> <br/>
