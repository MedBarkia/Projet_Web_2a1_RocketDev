  ...
  <div class="wrapper ">
    ...
    <table border="0" align="center">
        ...
        <tr>
            ...
            <td><input type="text" name="idp" id="idp" maxlength="20"  class="form-control" value = "<?php echo $_GET['idp'] ?>" disabled>  </td>
        </tr>
        <tr>
            <td>
                <label for="nom">nom:
        ...
        <tr>
            ...
            <td>
                <input type="marque" name="marque" id="marque"   class="form-control" >
            </td>
        </tr>
        <td>
            ...
            <td>
                <input type="date" name="dateajout" id="dateajout"   class="form-control" >
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="file" name="image" id="image"  class="form-control"  value = "<?php echo $_GET['image'] ?>" >>
            </td>
        </tr>
       <tr>
            <td>
...
function validateForm() {
  ...
  if (idp == 0) {
    alert("idp ne peut pas etre null");
    return false;
  }
    if (marque == "") {
    alert("marque vide");
