...
<body id="page-top" class="regular-navigation"  >
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#CATEGORIE" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"> CATEGORIEA <span class="pe-7s-angle-down"></span></a>
                        </li>
  ...
  <
        ...
        <section id="Specials" class="dark-wrapper top-border-me opaqued parallax" data-parallax="scroll" data-image-src="../asset/img/bg/bg4.jpg" data-speed="0.8">
            <div class="section-inner">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/dar el jeld.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/La salle à manger.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/La Closerie.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/L'Astragale.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/Le Comptoir de Tunis.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/Dar Belhadj.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/La Falaise.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/food/Restaurant Lemdina.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/8-in-1 Kitchen Tool.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Baker's Dusting Wand.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Piece Double Sided Silicone Utensils.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
...
?>
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Butter Spreader Knife.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Pineapple Corer.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Quesadilla Maker.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Lasagna Trio Pan.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Épicerie Sucrée & Salée.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Conserves.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Miel.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Fruits, Noix et Snacks.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Condiments & Sauces.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Huiles de cuisson, Huile d'olives.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/produit/Farine & Semoule.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../asset/img/produit/Thon & Sardine.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
        ...
        <section id="Book" class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="../asset/img/bg/bg4.jpg" data-speed="0.8">
            <div class="section-inner">
                 <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../asset/img/team/mohamed.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../asset/img/team/elaa.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                                    <h4>Boulifi Elaa</h4>
                                                    <p>Compellingly customize highly efficient outsourcing with premium quality vectors. Conveniently target customer directed relationships after highly efficient process improvements.</p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../asset/img/team/asma.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                                    <h4>Oudherfi Asma</h4>
                                                    <p>Compellingly customize highly efficient outsourcing with premium quality vectors. Conveniently target customer directed relationships after highly efficient process improvements.</p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../asset/img/team/dorsaf.PNG" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../asset/img/team/eya.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                                    <h4>Bouthoury Eya</h4>
                                                    <p>Compellingly customize highly efficient outsourcing with premium quality vectors. Conveniently target customer directed relationships after highly efficient process improvements.</p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../asset/img/team/mariem.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
