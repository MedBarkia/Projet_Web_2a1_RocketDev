  ...
  <div class="wrapper ">
    ...
    <table border="0" align="center">
        ...
        <tr>
            ...
            <td><input type="text" name="idp" id="idp" maxlength="20"  class="form-control" >  </td>
        </tr>
        <tr>
            <td>
                <label for="nom">nom:
...
function validateForm() {
  ...
  if (idp == 0) {
    ...
    alert("il va que la longeur du nom  depasse 5 ");
    return false;
  }
  if (marque.length<4) {

alert("il va que la longeur de la marque  depasse 4 ");
return false;
}
