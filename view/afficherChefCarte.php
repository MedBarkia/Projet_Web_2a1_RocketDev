...
<body id="page-top" class="regular-navigation">
    ...
    <div class="master-wrapper">
            ...
            <div class="container-fluid fullheight">
                <div class="vertical-center row">
                    ...
                    <div class="intro-text text-center smoothie col-sm-10 match-height">                    
                        <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.8s"><img src="../coup de chef/assets/img/intro-logo.png"></div>              
                    </div>
                ...
                <div>
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <h2 class="mb50">Disponibility  <span class="theme-accent-color">  And  </span>  Goal</h2>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 nopadding-lr dark-wrapper opaqued background-cover left-half" style="background-image: url('../coup de chef/assets/img/bg/bg10.jpg');">
                    <div class="dark-opaqued-half section-inner pad-sides-60 match-height" data-mh="promo-inner">
                        <h3 class="mb50">Roasted <span class="theme-accent-color"> Potato</span></h3>
                        ...
                        <p class="mt30"><a href="#contact" class="btn btn-primary btn-red page-scroll">VOIR RECETTE</a></p>
                    </div>
                </div>

                <div class="col-sm-6 nopadding-lr dark-wrapper opaqued background-cover right-half" style="background-image: url('../coup de chef/assets/img/bg/bg5.jpg');">
                    <div class="dark-opaqued-half section-inner pad-sides-60 match-height text-right" data-mh="promo-inner">
                        <h3 class="mb50">Mexican <span class="theme-accent-color">Pizza</span></h3>
                        <p class="lead mb50">Conveniently leverage other's distinctive expertise and backend metrics. Progressively harness intuitive systems and ethical niches. Continually drive extensible benefits vis-a-vis leading-edge meta-services. Conveniently leverage existing market-driven outsourcing vis-a-vis e-business process improvements. Intrinsicly extend quality interfaces with intermandated innovation.</p>
                        <div class="spacer-180"></div>
                        <p class="mt30"><a href="#contact" class="btn btn-primary btn-white page-scroll">VOIR RECETTE</a></p>
                    </div>
                </div>
            </div>
        </div>

        <section id="Specials" class="dark-wrapper top-border-me opaqued parallax" data-parallax="scroll" data-image-src="../coup de chef/assets/img/bg/bg4.jpg" data-speed="0.8">
            <div class="section-inner">
                                    ...
                                    <ul class="nav nav-justified icon-tabs" id="nav-tabs" role="tablist">
                                        <li role="presentation" class="active">
                                            <a href="#dustin" aria-controls="dustin" role="tab" data-toggle="tab">
                                                <span class="tabtitle heading-font">New Promotions</span>                                                
                                                <span class="tabtitle small"><p class="lead"></p></span>
                                            </a>
                                        </li>
                                        <li role="presentation" class="">
                                            <a href="#daksh" aria-controls="daksh" role="tab" data-toggle="tab">
                                               <span class="tabtitle heading-font">Black Friday</span>
                                        ...
                                        <li role="presentation" class="">
                                            <a href="#wafer" aria-controls="wafer" role="tab" data-toggle="tab">
                                                <span class="tabtitle heading-font">Tunisian Kitchen</span>
        ...
        <section id="the-menu">
            <div class="section-inner">
                 ...
                 <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                            <h2 class="section-heading">Browse <span class="theme-accent-color">Your</span> Choice</h2>
                            <hr class="thin-hr">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/dar el jeld.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/La salle à manger.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/La Closerie.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/L'Astragale.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/Le Comptoir de Tunis.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/Dar Belhadj.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/La Falaise.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/Restaurant Lemdina.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
            ...
            <div class="container">
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            <h2 class="mb50"><span class="heading-font text-uppercase">Plats</span></h2>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal4.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Foie de veau grillé <span class="theme-accent-color">13 MIN</span></h3>
                                        <p>1.Préparer une marinade avec l'huile, le thym et le laurier.
                                            2.Chauffer le grill. Passer les tranches de foie dans la marinade.
                                            Quadriller de chaque côté sur le grill. Servir chaud.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal2.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Lasagnes <span class="theme-accent-color">55 MIN</span></h3>
                                        <p>Huilez à l'huile d'olive un plat à gratin rectangulaire. Tapissez le fond de lasagne. Recouvrez d'une couche de viande, de sauce tomate et d'une fine couche de béchamel. Recouvrez de lasagnes et recommencez l'opération jusqu'à ce que le plat soit rempli. Ne le remplissez pas complètement jusqu'en haut, car en cuisant cela pourrait déborder. Terminez par une couche de sauce tomate et de béchamel. Parsemez de parmesan.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal1.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Carpaccio de bœuf  <span class="theme-accent-color">5 min</span></h3>
                                        <p>Agrémentez votre carpaccio d’oignons nouveaux, de radis et de thym frais. Arrosez l'ensemble d'huile d'olive Salez et poivrez.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 wow fadeIn">
                            <h2 class="mb50"><span class="heading-font text-uppercase">Spéciales</span></h2>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal3.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Pizza napolitaine <span class="theme-accent-color">40 MIN</span></h3>
                                        <p>Dans un cul-de-poule, mélanger à la main l’eau et le sel fin. Ajouter progressivement la farine de type 00 (moins riche en protéines pour une pâte plus digeste)</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal5.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Mahi-mahi <span class="theme-accent-color">20 MIN</span></h3>
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal6.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Tataki de boeuf <span class="theme-accent-color">15 MIN</span></h3>
                                        <p>Un pavé de boeuf juste saisi et mariné dans une sauce à base de sauce soja, de saké, d’ail, gingembre frais, de citron vert, puis découpé en très fines tranches façon carpaccio.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/food/meal7.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Poulet rôti <span class="theme-accent-color">58 MIN</span></h3>
                                        <p>Déposer le poulet sur la grille de la lèchefrite. Faire rôtir une heure. Retirer du four et incliner le poulet dans la lèchefrite pour que le jus s'échappe de la cavité. Arroser de jus et remettre le poulet au four.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="Produit">
            <div class="section-inner">
                 ...
                 <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                            <h2 class="section-heading">Choose <span class="theme-accent-color">Your</span> Product</h2>
                            <hr class="thin-hr">
                            <h3 class="section-subheading secondary-font">Best kitchen equipment brands , Food products .</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            <h2 class="mb50"><span class="heading-font text-uppercase">Equipements de la cuisine</span></h2>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/8-in-1 Kitchen Tool.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>8-in-1 Kitchen Tool <span class="theme-accent-color">28 DT</span></h3>
                                        <p>BUTEFO</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Baker's Dusting Wand.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Baker's Dusting Wand <span class="theme-accent-color">18 DT</span></h3>
                                        <p>OXO</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Piece Double Sided Silicone Utensils.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Piece Double Sided Silicone Utensils <span class="theme-accent-color">56 DT</span></h3>
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Electric Breakfast Sandwich Maker.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Electric Breakfast Sandwich Maker <span class="theme-accent-color">90 DT</span></h3>
                                        <p>HAMILTON BEACH</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Butter Spreader Knife.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Butter Spreader Knife <span class="theme-accent-color">15 DT</span></h3>
                                        <p>SIMPLE SPREADING</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Pineapple Corer.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Pineapple Corer <span class="theme-accent-color">33 DT</span></h3>
                                        <p>NEWNESS</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Quesadilla Maker.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Quesadilla Maker <span class="theme-accent-color">72 DT</span></h3>
                                        <p>HAMILTON BEACH</p>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Lasagna Trio Pan.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Lasagna Trio Pan <span class="theme-accent-color">68 DT</span></h3>
                                        <p>CHICAGO METALLIC</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                    <div class="row">
                        <div class="col-md-6 wow fadeIn">
                            <h2 class="mb50"><span class="heading-font text-uppercase">Produits alimentaires</span></h2>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Épicerie Sucrée & Salée.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Épicerie Sucrée & Salée <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Conserves.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Conserves <span class="theme-accent-color"></span></h3>                                      
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Miel.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Miel <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Fruits, Noix et Snacks.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Fruits, Noix et Snacks  <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 wow fadeIn">
                            ...
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Condiments & Sauces.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Condiments & Sauces <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Huiles de cuisson, Huile d'olives.PNG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Huiles de cuisson, Huile d'olives <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Farine & Semoule.jpg" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Farine & Semoule <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="food-menu-item">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <img src="../coup de chef/assets/img/produit/Thon & Sardine.JPG" class="img-responsive">
                                    </div>
                                    <div class="col-xs-9">
                                        <h3>Thon & Sardine <span class="theme-accent-color"></span></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="Book" class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="../coup de chef/assets/img/bg/bg4.jpg" data-speed="0.8">
            <div class="section-inner">
                 <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                            <h2 class="section-heading">Nos <span class="theme-accent-color">Meilleurs</span> Chefs</h2>
                            <hr class="thin-hr">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../coup de chef/assets/img/team/mohamed.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../coup de chef/assets/img/team/elaa.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                                    <h4>Boulifi Elaa</h4>
                                                    <p>Compellingly customize highly efficient outsourcing with premium quality vectors. Conveniently target customer directed relationships after highly efficient process improvements.</p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../coup de chef/assets/img/team/asma.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                                    <h4>Oudherfi Asma</h4>
                                                    <p>Compellingly customize highly efficient outsourcing with premium quality vectors. Conveniently target customer directed relationships after highly efficient process improvements.</p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../coup de chef/assets/img/team/dorsaf.PNG" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../coup de chef/assets/img/team/eya.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
                                                    <h4>Bouthoury Eya</h4>
                                                    <p>Compellingly customize highly efficient outsourcing with premium quality vectors. Conveniently target customer directed relationships after highly efficient process improvements.</p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-8 col-xs-offset-2 item-caption">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <img src="../coup de chef/assets/img/team/mariem.jpg" class="img-responsive testimonial-author" alt="">
                                                </div>
                                                <div class="col-sm-10">                                                
        ...
        <section class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="../coup de chef/assets/img/bg/bg1.jpg" data-speed="0.8">
            <div class="section-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100">
                            ...
                            <hr class="thin-hr">
                            <h3 class="section-subheading secondary-font">Delivery time.</h3>
                        </div>
                    </div>
                </div>
                <div class="container">
