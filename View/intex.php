            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                        <li><a href="modifierUtilis.php" class="page-scroll">Paramètres généraux du compte
</a></li>  

                        <li> <a href="deconnexion.php" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Déconnexion <span class="pe-7s-angle-down"></span></a>
                        </li>
