                ...
                <a class="nav-link" href="javascript:;">
                  ...
                  <p class="d-lg-none d-md-block">
                    Stats
                            	...
                            	<button><a href="afficherAdmin.php">Admin </a></button>
                           <button><a href="afficherLivreur.php">Livreur </a></button>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <h4 class="card-title">Edit usrs Profile</h4>

                  <p class="card-category">Complete usrs profile</p>
                </div>
